...
- `foldable.js` — fullscreen live resizing, hinge placement, canvas synchronization, Escape pause/resume, cursor-directed Shift-to-RAM, the four playable vehicles (car, vacuum, helicopter, toaster) and their abilities, the shared/individual skill split with the intermission garage, browser-local autosaving, confirmed New Game controls, and secondary segment UI.
